...
export const homeScreenCards = [
  {
    ...
    components: [
      {
        title: "Buttons",
        path: "/all-components/buttons",
        component: <Buttons />,
        image: ButtonIcon,
      },
      {
        title: "Check box",
        path: "/all-components/check-box",
        component: <CheckBox />,
        image: "",
      },
      {
        title: "Slider",
        path: "/all-components/slider",
        component: <Slider />,
        image: "",
      },
      {
        title: "Input",
        path: "/all-components/input",
        component: <TextField />,
        image: "",
      },
      {
        title: "Chips",
        path: "/all-components/chip",
        component: <Chips />,
        image: "",
      },
      {
        title: "Floating action button",
        path: "/all-components/fab",
        component: <Fab />,
        image: "",
      },
      {
        title: "Icon buttons",
        path: "/all-components/icon-buttons",
        component: <IconButton />,
        image: "",
      },
      {
        title: "Lists",
        path: "/all-components/list",
        component: <Lists />,
        image: "",
      },
      {
        title: "Menu",
        path: "/all-components/menu",
        component: <Menu />,
        image: "",
      },
      {
        title: "Radio Buttons",
        path: "/all-components/radio-buttons",
        component: <RadioButton />,
        image: "",
      },
      {
        title: "Select",
        path: "/all-components/select",
        component: <SelectBox />,
        image: "",
      },
      {
        title: "Switch",
        path: "/all-components/switch",
        component: <Switch />,
        image: "",
      },
    ],
  ...
  // how to section
  {
    ...
    components: [
      {
        title: "Tabs",
        path: "/all-components/tabs",
        component: <Tabs />,
        image: "",
      },
      {
        title: "Accrodion",
        path: "/all-components/accordion",
        component: <Accordion />,
        image: "",
      },
      {
        title: "Avatar",
        path: "/all-components/avatar",
        component: <Avatar />,
        image: "",
      },
      {
        title: "Button group",
        path: "/all-components/button-group",
        component: <ButtonGroup />,
        image: "",
      },
      {
        title: "Images",
        path: "/all-components/images",
        component: <Images />,
        image: "",
      },
      {
        title: "Caursoul",
        path: "/all-components/caursoul",
        component: <Caursoul />,
        image: "",
      },
      {
        title: "Todo",
        path: "/all-components/todo",
        component: <Todo />,
        image: "",
      },
      {
        title: "Tables",
        path: "/all-components/tables",
        component: <Table />,
        image: "",
      },
      {
        title: "Drag and drop",
        path: "/all-components/drag-and-drop",
        component: <DragAndDrop />,
        image: "",
      },
      // {
      //   title: "Custom cards",
      //   path: "/all-components/cards",
      //   component: <Cards />,
      //   image: "",
      // },
      {
        title: "Top navigation",
        path: "/all-components/top-nav",
        component: <TopNavigation />,
        image: "",
      },
      {
        title: "Bottom navigation",
        path: "/all-components/bottom-navigation ",
        component: <BottomNavigation />,
        image: "",
      },
      {
        title: "Drop downs",
        path: "/all-components/drop-downs",
        component: <DropDowns />,
        image: "",
      },
      {
        title: "Side navigation",
        path: "/all-components/side-navigation",
        component: <Drawer />,
        image: "",
      },
      // {
